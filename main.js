...
function Download(){
  ...
  <center>
    ...
    DMAT (Lang 1.2) - Linux : <a href="downloads/dmat-intepreter-1.2.zip" download="dmat-intepreter-1.2.zip">Download</a> | <a href="downloads/dmat-intepreter-1.2-src.zip" download="dmat-intepreter-1.2-src.zip">(Source)</a> | <a href="downloads/dmat-1.2-documentation.txt" download="dmat-lang-1.2-documentation.txt">(Documentation)</a> | <a href="https://github.com/Dmatorg/dmat-intepreter/tree/v1.2">(Github Source)</a>
    <br>
...
Thanks for reading this documentation ended by ghgltggamerofficially at same day : 21:16
  ...
  <h1>DMAT 1.2 Official Documentation</h1>
<p><em>Written by ghgltggamer officially</em></p>
<p><em>Writing started at: 21:13, 22 jul 2024</em></p>
...
<h3>About Current Version</h3>
<ul>
  <li>This documentation was written for DMAT (Lang 1.2) and may not be accurate for future DMAT releases or versions.</li>
  <li>This version of DMAT only is able to convert ALBEDO images into NORMAL, HEIGHT, ROUGHNESS, and METALLIC maps.</li>
</ul>
...
<pre>
*WE CAN PARSE ANYTHING here in DMAT 1.2*
*THIS MATERIAL IS COMPILABLE WITH DMAT 1.2*
*COPYRIGHT (C) GHGLTGGAMER*
*WRITING AT 21:15 AT 22 JUL 2024*
*NOTE THAT DMAT CAN CHANGE THE SYNTAX IN FUTURE OR FUNCTIONS HERE USED MAY NOT BE AVAILABLE IN FUTURE WITH SAME NAME*
...
<ul>
  ...
  <li><strong>DMAT_ROUGHNESS</strong>: is used to define ROUGHNESS MAP Output file</li>
  <li><strong>DMAT_METALLIC</strong>: is used to define METALLIC MAP Output file</li>
  <li><strong>INIORMAL</strong>: (Used to define the Intensity of the S params, In simple language this will set the pixel intensity of the maps which can range from 0 to 255, 0 means highly pixalated also known as FOZ DTX HYPER NORMALS but these can look soo ugly due to pixel density and whien screen profile, 255 means so soft and contains the common normal map pixel informations which are not widely used but this totaly depnds on the albedo color pixels to be intensied, intensity will affect all the maps, 0 will bring it highly pixelated with strong colors and 255 will make more visible pixels and common color profile any number between 0 to 255 can be setted as intensity</li>
  <li><strong>IHEIGHT</strong>:works same as INORMAL but used for height map intensity</li>
  <li><strong>IROUGHNESS</strong>:works same as INORMAL but used for roughness map intensity</li>
  <li><strong>IMETALIC:</strong>:works same as INORMAL but used for metalic map intensity</li>
  <li><strong>EXIT&BUILD</strong>: is used to finally exit the program; this is important because without this DMAT will only fill up the memory buffer but not build the PBR files as DMAT processes everything after exiting the program.</li>
</ul>
...
Example:<br>
./dmat example.dmat (Linux)

for windows and other consider compiling the source code snd then use the command.
